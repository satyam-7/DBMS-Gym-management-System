...
<body class="page-body login-page login-form-fall">
	...
	<div class="login-header login-caret">
		...
		<td width="200" height="200" ><img src="dashboard/admin/logo.png" style="margin-top:-50px;" width="150" height="150"  alt=""/></td>
			<h1 style="color:white; font-size:50px; margin-bottom:-80px;">ALPHA GYM</h1>
